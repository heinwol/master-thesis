...
- $Gen_(G)(V_x)$ -- подграф графа $G$, порожденный подмножеством $V_x subset V$ вершин графа $G$.
...
#proof[
  #fli[
    ...
    $
      Phi((v_1, v_2)) = Phi_1((v_1, v_2)) = (Phi_1(v_1), Phi_2(v_2)) = (Phi(v_1), Phi(v_2));
    $ <nonum>
