...
Отметим, что у сети на @fig:sn_on_cylinder_1 число столбцов до факторизации было четным. Для сравнения приведем
...
#theorem[
  ...
  $
    "Aut"(quo("SN", eqcyl)) tilde.equiv "Aut"("SN") times quo(ZZ, (tilde(m) - 1) ZZ).
  $
]
